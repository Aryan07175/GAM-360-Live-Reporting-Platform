  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <div
          role="alert"
          className="flex items-start gap-3 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-600 dark:text-red-400"
        >
          ...
          <div className="flex-1">
            ...
            <p className="mt-0.5 text-red-500/80 dark:text-red-400/80">{error}</p>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <Button
              size="sm"
              variant="outline"
              className="h-7 border-red-500/30 text-red-600 hover:bg-red-500/10 dark:text-red-400 text-xs"
              onClick={() => { clearError(); generateReport(); }}
            >
              Retry
            </Button>
            <button
